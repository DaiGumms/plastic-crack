...
**Plastic Crack** is a comprehensive model/miniature collection management application with web,
mobile, and backend components. The main goal is to provide hobbyists with tools to catalog, track,
and manage their plastic model collections with features like photo management, painting progress
